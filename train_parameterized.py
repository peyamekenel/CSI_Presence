...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train CSI presence detection model')
    parser.add_argument('--dataset', type=str, default='DP_LOS',
                      choices=['DP_LOS', 'DP_NLOS', 'DA_LOS', 'DA_NLOS'],
    ...
    # Set data directory
    data_dir = f"data/{args.dataset}/{args.dataset}"
    ...
    train_losses, val_losses = train_model(
        model, train_loader, val_loader, criterion, optimizer, num_epochs=args.epochs, device=device
    )
